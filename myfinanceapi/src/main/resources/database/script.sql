...
-- Schema my_finance_api
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `my_finance_api` DEFAULT CHARACTER SET utf8mb3 ;
USE `my_finance_api` ;
...
CREATE TABLE IF NOT EXISTS `my_finance_api`.`transaction` (
  ...
  `type` ENUM('EXPENSE', 'REVENUE') CHARACTER SET 'utf8mb3' NOT NULL,
